 ...
 * @version 0.0.1
 *
 *          AnalyticsCounter read a file, list them alphabetically and count the
 *          number of repetition, this class call: "CountingSymptoms",
 *          "ReadSymptomDataFromFile", "WriteSymptomFile"
 */
public class AnalyticsCounter {
	...
	public TreeMap<String, Integer> getSymptomsCount(List<String> symptomsList) throws IOException {
		...
		TreeMap<String, Integer> symptomsMap = (TreeMap<String, Integer>) countingSymptoms
				.getSymptomsCount(symptomsList);
